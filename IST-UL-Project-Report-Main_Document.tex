...
\caption{Probability distribution of first-year Profit obtained from the Monte Carlo simulation}
\label{fig:profit_dist}
\end{figure}
 \begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{Cumulative.png}
\caption{Ascending cumulative distribution}
\label{fig:profit_dist}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{tornado_regression.png}
\caption{Probability distribution of first-year Profit obtained from the Monte Carlo simulation}
\label{fig:profit_dist}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Probability distribution of first-year Profit considering correlation between selling price and sales volume}
...
From Table~\ref{tab:profit_2c}, it can be observed that accounting for the correlation between sales and selling price leads to noticeable changes in the Profit statistics. In particular, the standard deviation decreases by about 10.35~M\euro{} (from 58.76 to 48.41~M\euro{}), corresponding to an 18\% reduction in dispersion.

Moreover, the 5th percentile increases from $-8.77$~M\euro{} to 1.2~M\euro{}, substantially reducing extreme loss scenarios, while the 95th percentile decreases from 182.2~M\euro{} to 160.2~M\euro{}. These results indicate a narrower Profit range, with 90\% of outcomes lying between 1.2 and 160.2~M\euro{} when correlation is considered, thus increasing confidence in the analysis.


\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\linewidth]{WhatsApp Image 2026-01-16 at 17.33.41.jpeg}
    \caption{Probability distribution of first-year Profit without considering correlation between selling price and sales volume}
    \label{fig:profit_dist_no_corr}
\end{figure}


When correlation is considered, the probability of obtaining a negative Profit decreases by approximately 2.4 percentage points, from 7.4\% to 5.0\%, reflecting the increase observed in the 5th percentile. Although the average Profit is slightly lower due to the negative correlation between selling price and sales, the results show reduced variability and increased reliability, with a lower risk of losses. Figures~\ref{fig:profit_dist_corr} and~\ref{fig:profit_dist_no_corr} illustrate the narrower Profit range obtained when correlation is accounted for.

Comparing these results with those from Question~2a, the obtained statistics closely resemble those of the scenario with a selling price of 1.17~M\euro{}, which is consistent with this value being the mode of the triangular distribution used to model the selling price.

Finally, the tornado diagrams in Figures~\ref{fig:tornado_2c_corr} and~\ref{fig:tornado_2c_no_corr} show that, although selling price now influences Profit, sales volume remains the dominant driver, followed by unit cost and fixed costs. The inclusion of selling price increases uncertainty but does not alter the ranking of the most influential variables.

\begin{figure}[h]
\centering
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{WhatsApp Image 2026-01-16 at 17.50.21 (1).jpeg}
    \caption{Tornado diagram for first-year Profit with correlation}
    \label{fig:tornado_2c_corr}
\end{minipage}
\hfill
\begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\textwidth]{WhatsApp Image 2026-01-16 at 17.37.28.jpeg}
    \caption{Tornado diagram for first-year Profit without correlation}
...
\begin{figure}[h]
    ...
    \caption{Probability distribution of Net Present Value (NPV)}
    \label{fig:npv_dist}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Tornado diagram for Net Present Value (NPV)}
